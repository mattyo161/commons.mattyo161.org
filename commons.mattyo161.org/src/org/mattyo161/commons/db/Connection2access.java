...
class Connection2access implements IConnection2Db 
{
    /**
	...
	public String getJdbcUrl(String server,
	        ...
	        String options) 
	{
        String dbURL = "jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=" + db + ";DriverID=22";
        if (options.indexOf("READ") < 0) {
        	dbURL += ";READONLY=true";
        }
        if (!options.equals("")) {
            dbURL += ";" + options;
