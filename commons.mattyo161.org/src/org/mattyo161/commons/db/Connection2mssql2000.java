 ...
 * to an Microsoft SQL 2000 Server. This funciton should not be called individually
...
class Connection2mssql2000 implements IConnection2Db 
{
    /**
     ...
     *Microsoft SQL 2000 (server, port, user, password, db and options)
     */
    ...
    /**
     *Will load the JDBC driver and create a Connection object for the specified
     *Microsoft SQL 2000 (server, port, user and password)
     */
    ...
    /**
     *Will load the JDBC driver and create a Connection object for the specified
     *Microsoft SQL 2000 (server, port, user, password and db)
     */
