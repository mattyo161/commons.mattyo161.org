 ...
 * to an Postgres server. This function should not be called individually
...
class Connection2postgres implements IConnection2Db 
{
    /**
	...
	public String getJdbcUrl(String server,
	        ...
	        String options) 
	{
	    String dbURL = "jdbc:postgresql://" + server;
        if (!port.equals("")) {
            dbURL += ":" + port;
        }
        dbURL += "/" + db;
